...
SELECT id, nome, codigo, pontos, vitorias, empates, derrotas 
FROM clubes 
ORDER BY pontos DESC, (golos_marcados - golos_sofridos) DESC, vitorias DESC;
